...
import (
	...
	scheme "github.com/mohuishou/blog-code/02-k8s-operator/operator-kubebuilder-clientset/pkg/clientset/v1/scheme"
...
func newTests(c *JobV1Client, namespace string) *tests {
	return &tests{
		client: c.RESTClient(),
		ns:     namespace,
	}
